...
/**
 * Componente de Cabecera Adaptado de la estructura HTML de Spotify.
 *
 * Corrección aplicada: Se eliminó 'React' de la importación
 * porque solo se usa el Hook 'useState', resolviendo la advertencia de ESLint.
 */
function SpotifyHeader() {
  // Estado para el menú desplegable "Planes Premium"
  const [isPremiumDropdownOpen, setIsPremiumDropdownOpen] = useState(false);
  // Estado para el botón del menú móvil
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  // Función para alternar el estado del dropdown premium
  ...
  return (
    <div className="mh-container">
      <div className="mh-brand-wrapper">
        <a href="/" className="mh-header-primary">
          <span className="mh-header-primary">
            {/* SVG del logo de Spotify - Adaptado a JSX */}
      ...
      <nav role="navigation" className="mh-desktop" aria-label="Navegación en el ordenador">
        <ul>
          <li className="mh-premium">
            <button
              onClick={togglePremiumDropdown}
              className="mh-header-primary"
              aria-expanded={isPremiumDropdownOpen}
              aria-controls="premiumMenu"
            >
              <div className="mh-premium-title">
            ...
            {isPremiumDropdownOpen && (
              <div id="premiumMenu" className="mh-dropdown-menu">
                <ul>
                  <li className="plan"><a href="/premium/individual"><span className="plan-title">Premium Individual</span> <span>1 cuenta para una persona.</span></a> </li>
                  <li className="plan"><a href="/premium/duo"><span className="plan-title">Premium Duo</span> <span>2 cuentas para parejas en un mismo domicilio.</span></a> </li>
                  <li className="plan"><a href="/premium/family"><span className="plan-title">Premium Familiar</span> <span>Hasta 6 cuentas para familiares que viven en un mismo domicilio.</span></a> </li>
                  <li className="plan"><a href="/premium/student"><span className="plan-title">Premium para Estudiantes</span> <span>1 cuenta con descuento para estudiantes que cumplan los requisitos.</span></a> </li>
                </ul>
              </div>
            )}
          </li>
          ...
          {/* Enlaces Estáticos */}
          <li><a href="/help" className="mh-header-primary">Asistencia</a></li>
          <li><a href="/download" className="mh-header-primary">Descargar</a></li>

          {/* Separador */}
          <li role="separator" aria-hidden="true" className="mh-header-primary"></li>

          {/* Enlaces Secundarios */}
          <li><a href="/signup" className="mh-header-secondary mh-tier-2">Registrarse</a></li>
          <li><a href="/login" className="mh-header-secondary mh-tier-2">Iniciar sesión</a></li>
        </ul>
      </nav>
      ...
      <div className="mh-mobile-menu">
        <button
          type="button"
          className={`mh-header-primary ${isMobileMenuOpen ? 'mh-menu-open' : 'mh-menu-closed'}`}
          onClick={toggleMobileMenu}
          aria-expanded={isMobileMenuOpen}
          aria-controls="mh-mobile-navigation"
        >
          <span className="mh-sr-only">Menu</span>
          <span className="mh-icon-bar"></span>
          <span className="mh-icon-bar"></span>
          <span className="mh-icon-bar"></span>
        </button>
      </div>
